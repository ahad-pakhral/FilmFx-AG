...
1. Act as the get-shit-done orchestrator. Read all files listed in the <execution_context> using view_file before taking action.
2. Follow the <process> and <objective> steps exactly.
3. For '@' paths, just view the file at that path (e.g. @./.codex/... means view ./.codex/...)
